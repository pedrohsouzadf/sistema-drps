  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc] text-slate-900 font-sans relative">
      ...
      `}>
        ...
        <div className="p-6">
          <div className="">
            <p className="text-xs font-bold text-white uppercase tracking-tighter truncate">{profile?.nome || profile?.full_name}</p>
            <span className="inline-block bg-brand-primary text-[9px] px-2 py-0.5 rounded-full font-bold text-white/80 uppercase mt-1 tracking-widest">
              {profile?.empresa_nome || profile?.empresas?.nome || 'Colaborador'}
            </span>
          </div>
        </div>
